...
/*
            ...
            GridSize gridSize = new GridSize(this.getChildCount(), 2);

            try{
                shortcut = (ShortcutInfo) tag;
                Drawable icons = new BitmapDrawable(getResources(), shortcut.getIcon(new IconCache(Launcher.getLauncherActivity(), Launcher.getLauncher(getContext()).getDeviceProfile().inv)));
                shortcutses = ShortcutsManager.getShortcutsBasedOnTag(Launcher.getLauncherActivity().getApplicationContext(), Launcher.getLauncherActivity(), shortcut, icons);
                ShortcutsBuilder builder = new ShortcutsBuilder.Builder(Launcher.getLauncherActivity(), Launcher.getMasterLayout())
                        .launcher3Shortcuts(gridSize, shortcut.rank, (int)v.getY(), v.getBottom(), false, Utilities.getDockSizeDefaultValue(Launcher.getLauncherActivity().getApplicationContext()))
                        .setOptionLayoutStyle(StyleOption.NONE)
                        .setPackageImage(icons)
